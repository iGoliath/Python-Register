...
class AddTaxFrame(BaseFrame):
    ...
    def build_widgets(self):
        ...
        tk.Label(self, text="Is the item taxable?:", font=("Arial", 50), width=25).grid(
        ...
        tk.Button(
            ...
            text="Yes",
            font=("Arial", 100),
            command=lambda: self.wm.tax_var.set("1"),
        ).grid(column=0, row=0, sticky="ew")
        tk.Button(
            yes_no_frame,
            text="No",
            font=("Arial", 100),
            command=lambda: self.wm.tax_var.set("0"),
        ...
        self.add_tax_back_button.grid(column=0, row=0, sticky="ew", padx=(0, 15))
        tk.Button(
            back_quit_frame,
            text="Quit",
            font=("Arial", 50),
    ...
    def on_show(self, reentering=True):
        ...
        if reentering:
            self.add_tax_back_button.config(
